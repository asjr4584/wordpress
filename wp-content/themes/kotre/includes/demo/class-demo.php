...
if ( ! class_exists( 'Kotre_Demo' ) ) {
	...
	class Kotre_Demo {
		...
		/**
		 * Singleton instance of Kotre_Demo.
		 *
		 * @var Kotre_Demo $instance Kotre_Demo instance.
		 */
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Kotre_Demo ) ) {
				self::$instance = new Kotre_Demo();
